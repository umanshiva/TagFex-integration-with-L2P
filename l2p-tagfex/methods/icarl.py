...
from modules import optimizer_dispatch, scheduler_dispatch, backbone_dispatch, get_loaders
...
class iCaRL(HerdingIndicesLearner):
    ...
    def extract_herding_features(self, dataset: torch.utils.data.Dataset) -> torch.Tensor:
        ...
        for samples, targets in data_loader:
            ...
            feats = self.local_network(samples.contiguous())["features"]
